...
- **Files to be Created/Updated:**
  - `search_keywords.md`: To define the exact Boolean search strings (e.g., _“Hamming Code (7,4)” AND “IoT Sensor Transmission”_) used on IEEE Xplore, Google Scholar, and Scopus.
