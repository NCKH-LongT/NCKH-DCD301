...
\author{
  Hoang Huy Nguyen\inst{1} \and
  Quoc Nam Tran\inst{1} \and
  The Bao Nguyen\inst{1} \and
  Than Quy Dam\inst{1}
}
\authorrunning{H.H. Nguyen et al.}

\institute{
  Information Technology, FPT University, Ho Chi Minh City, Vietnam\\
  \texttt{SE180429 \quad SE194108 \quad SE182362 \quad SE184111}
}
