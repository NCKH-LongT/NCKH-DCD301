...
\author{
  Hoang Huy Nguyen\inst{1}\thanks{SE180429} \and
  Quoc Nam Tran\inst{1}\thanks{SE194108} \and
  The Bao Nguyen\inst{1}\thanks{SE182362} \and
  Than Quy Dam\inst{1}\thanks{SE184111}
}
\authorrunning{H.H. Nguyen et al.}

\institute{Information Technology, FPT University, Ho Chi Minh City, Vietnam}
